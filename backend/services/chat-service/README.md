...
| 2 | `GET` | `/messages/{session_id}` | Yes | Paginated message history (skip, limit, oldest-first) |
| 3 | `POST` | `/sessions` | Yes | Create 1-to-1 chat session (or return existing if same pair exists) |
