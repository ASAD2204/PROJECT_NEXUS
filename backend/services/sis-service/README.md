...
| # | Method | Path | Auth | Description |
|---|--------|------|------|-------------|
| 16 | `GET` | `/programs` | No | List all programs |
...
| # | Method | Path | Auth | Description |
|---|--------|------|------|-------------|
| 20 | `GET` | `/faculty` | Admin | List all faculty |
| 21 | `POST` | `/faculty` | Admin | Create faculty profile |
| 22 | `PUT` | `/faculty/{faculty_id}` | Admin | Update faculty profile |

### Notifications
| # | Method | Path | Auth | Description |
|---|--------|------|------|-------------|
| 23 | `GET` | `/notifications` | Yes | List user's notifications |
| 24 | `PUT` | `/notifications/{notification_id}/read` | Yes | Mark notification as read |
| 25 | `PUT` | `/notifications/read-all` | Yes | Mark all notifications as read |

### Grade Cache (Redis)
| # | Method | Path | Auth | Description |
|---|--------|------|------|-------------|
| 26 | `GET` | `/grades/{student_id}/{course_id}` | Yes | Get grade from Redis cache (2h TTL, DB fallback) |

### CGPA Leaderboard (Redis Sorted Set)
| # | Method | Path | Auth | Description |
|---|--------|------|------|-------------|
| 27 | `GET` | `/leaderboard/{program_id}/{semester_id}` | Yes | CGPA leaderboard (1h TTL, optional `?top=10`) |

### Health
| # | Method | Path | Auth | Description |
|---|--------|------|------|-------------|
| 28 | `GET` | `/health` | No | Health check |
