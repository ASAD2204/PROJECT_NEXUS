...
DB_KEYWORDS = [
    ...
    "my schedule", "my timetable", "my section", "my sections",
    "assigned sections", "teaching sections", "sections am i teaching",
]
...
Categories:
[db_query] — User asks about their own data: grades, GPA, attendance, courses, fees, invoices, profile, scores, deadlines, class schedule, or teaching sections
