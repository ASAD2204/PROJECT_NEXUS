...
const LibrarianReports = () => {
  ...
  const handleDownloadReport = async () => {
    try {
      const response = await libraryAPI.downloadReport();
      const url = window.URL.createObjectURL(new Blob([response.data]));
      const link = document.createElement('a');
      link.href = url;
      link.setAttribute('download', `library_report_${new Date().toISOString().slice(0, 10)}.pdf`);
          ...
          <Grid size={{ xs: 12 }}>
            <Card sx={{ 
              ...
              <CardContent>
                ...
                <Box sx={{ width: '100%', height: 320, minHeight: 320, mt: 2 }}>
          ...
          <Grid size={{ xs: 12 }}>
            <Card sx={{ 
              ...
              <CardContent>
                ...
                <Box sx={{ width: '100%', height: 320, minHeight: 320, mt: 1 }}>
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <defs>
