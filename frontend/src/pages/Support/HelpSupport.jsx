...
const HelpSupport = () => {
  ...
  const handleSubmitTicket = async () => {
    ...
    try {
      ...
      setSubmitError(error.response?.data?.detail || 'Unable to submit support ticket right now.');
    } finally {
      setSubmitting(false);
    }
  };
              ...
              <CardContent>
                ...
                <Stack spacing={2}>
                  ...
                  <Button
                    ...
                    disabled={submitting || !ticketForm.subject || !ticketForm.category || !ticketForm.description}
                    sx={{ py: { xs: 1.5, sm: 1 } }}
                  >
