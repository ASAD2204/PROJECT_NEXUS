  ...
  useEffect(() => {
    const fetchAssignments = async () => {
      try {
        ...
        const pending = data.reduce((s, a) => s + (a.pending || 0), 0);
        const graded = data.reduce((s, a) => s + (a.graded || 0), 0);
        setStats([
          { title: 'Total Assignments', value: String(data.length), icon: AssignmentIcon, color: 'primary.main', tooltip: 'Total assignments across all courses' },
